...
public class MainTestAppJunit {
	...
	@Disabled
		...
		public void checkContactForm(String tcid,String name, String email, String details, String succmsg) throws Throwable{
			try {
			driver.get("file:///C:\\Users\\Administrator\\eclipse-workspace\\com.seleniumeg_pomm\\src\\main\\resources\\Home.html");
			//create home page instance
			HomePage homePage = new HomePage(driver);
			...
			ExcelWriteUtils.writeTCResult(tcid, "PASS", "");
				...
				//test case fail
				ExcelWriteUtils.writeTCResult(tcid, "FAIL", ae.getMessage()+getStackTrace(ae));
				ae.printStackTrace();
				throw ae;}
			catch(Exception ae) {
				//test case error;
